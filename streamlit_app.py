    ...
    if k_str[0] == k_str[1] == k_str[2] == k_str[3]:
        ...
        while True:
            ...
            if last_time:
                ...
                st.markdown("<h1 style='font-size:50px;'>The last two subtracted values are **6174**.\n\nSo the subtracted value will be the same for infinite times.</h1>", unsafe_allow_html=True)
                time.sleep(5)
